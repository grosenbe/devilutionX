...
GameplayOptions::GameplayOptions()
    ...
    , sharedExperience("Shared Experience", OptionEntryFlags::CantChangeInMultiPlayer, N_("Shared Eperience"), N_("Eperience for killed monsters is shared by all party members."), false)
